package sga.JSONParser.SpectraProcessor;
...
import sga.JSONParser.Entities.Coordinate;
import sga.JSONParser.Entities.MetaData;
...
public class SpectraProcessor{
	...
	public String processFile(String path)
	{
		...
		try
    	{
    		...
    		String ans = new Gson().toJson(new MetaData(parts[0],parts[1],parts[2],parts[3].substring(0, parts[3].length()),coordinates));
