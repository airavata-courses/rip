  ...
  <div id="app">
    ...
    <!--<div class="container">-->
      <!--<div class="Chart__list">-->
        <!--<div class="Chart">-->
          <!--<h2>Linechart</h2>-->
          <!--&lt;!&ndash;<line-example></line-example>&ndash;&gt;-->
        <!--</div>-->
      <!--</div>-->
    <!--</div>-->
    ...
    <div class="container">
      ...
      <canvas id="plan-chart"></canvas>
        ...
        <h2>Metadata Upload Unsuccessful! </h2>
        <p>
...
<script>
  ...
  import {check} from './customFunctions';
  ...
  import Chart from 'chart.js';
    ...
    //
    // }
  // import LineExample from './chem-chart.js';
  ...
  // },
    ...
    methods: {
     ...
     const myChart = new Chart(ctx, {
      ...
      generate_graphs(formData) {
        ...
        // graph();
        // console.log(axios.get("http://127.0.0.1:3001/getfiles/"));
       ...
       // chartData.data.datasets = result[0];
    ...
    // }, {responsive: true, maintainAspectRatio: false});
      ...
      printname(name)
    {
      //document.getElementById('downloadfiles').src=name;
